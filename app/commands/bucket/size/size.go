...
var BucketSizeCmd = &cobra.Command{
	Use:   "size",
	Short: `Bucket size`,
	Long:  ``,
	Run:   run,
...
func init() {
	...
	BucketSizeCmd.Flags().String("created-before", defaultDate, "created before Ex:20211031")
}
...
func run(cmd *cobra.Command, args []string) {
	...
	bucketUtils.ProcessBuckets(ctx, client, project, createdBefore, true, false)
}
